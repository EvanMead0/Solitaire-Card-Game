...
def update():
    ...
    if hand:
        ...
        hand[-1].c_box = pygame.Rect(hand[-1].x, hand[-1].y, 50, 70)
    else:
    ...
    for x in range(len(table)):
        if table[x]:
            ...
            table[x][-1].c_box = pygame.Rect(table[x][-1].x, table[x][-1].y, 50, 70)
        else:
